...
extern "C" void Java_com_example_nabeo_wifiapp_AsyncTaskTrain_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_com_example_nabeo_predictlibrary_Predict_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
*/
extern "C" JNIEXPORT int JNICALL Java_com_example_nabeo_wifiapp_WifiApp_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_com_example_nabeo_wifiapp_WifiApp_testLog(JNIEnv *env, jobject obj, jstring logThis){
